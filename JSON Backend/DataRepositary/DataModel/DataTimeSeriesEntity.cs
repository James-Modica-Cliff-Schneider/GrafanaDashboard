...
{
    public class DataTimeSeriesEntity : TableEntity
    {
        public DataTimeSeriesEntity()
        {
        }

        public DataTimeSeriesEntity(string partitionKey, string rowKey)
        {
        ...
        {
            return new DateTime(Int64.MaxValue - Int64.Parse(RowKey));
        }
    }
